...
const TYPE_OPTIONS: { value: ToiletTypeOption; label: string; desc: string; color: string }[] = [
    { value: 'lelaki',    label: 'Lelaki',    desc: 'Tandas khusus lelaki',           color: 'text-blue-600' },
    { value: 'perempuan', label: 'Perempuan', desc: 'Tandas khusus perempuan',        color: 'text-pink-600' },
    { value: 'unisex',    label: 'Unisex',    desc: 'Tandas untuk semua jantina',     color: 'text-violet-600' },
    { value: 'oku',       label: 'OKU',       desc: 'Orang Kurang Upaya',             color: 'text-amber-600' },
];
...
export default function Create() {
    const { data, setData, post, processing, errors } = useForm<FormData>({
        ...
        latitude:     '',
        longitude:    '',
        toilet_types: [{ type: '', bilangan_kubikel: '' }],
    });
    ...
    const updateToiletType = (index: number, field: keyof ToiletTypeRow, value: string) => {
        setData(
            'toilet_types',
            data.toilet_types.map((row, i) => (i === index ? { ...row, [field]: value } : row)),
        );
    };
    ...
    return (
        <AppLayout
            title="Tambah Premis Tandas"
            subtitle="Daftar premis tandas baru untuk penilaian audit"
        >
            <Head title="Tambah Premis" />

            <div className="max-w-3xl mx-auto">
                <form onSubmit={(e) => { e.preventDefault(); post('/toilets'); }} className="space-y-5">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        <div className="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-400">Maklumat asas premis tandas</p>
                            </div>
                        </div>
                        ...
                        <div className="px-6 py-5 space-y-4">
                            ...
                            <InputField label="Alamat" error={errors.alamat}>
                                <textarea
                                    ...
                                    rows={3}
                                    placeholder="cth: Jalan Pahang, 50586 Kuala Lumpur, WP Kuala Lumpur"
                            ...
                            <p className="text-xs text-gray-400">
                                Koordinat GPS adalah pilihan. Gunakan Google Maps untuk mendapatkan koordinat.
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-400">Tambah satu atau lebih jenis tandas</p>
                                </div>
                            </div>
                            <button
                                type="button"
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <select
                                            ...
                                            className={`w-full rounded-xl border px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all ${
                                                typeError(index, 'type') ? 'border-red-400' : 'border-gray-300'
                                            }`}
                                        >
                                    ...
                                    <div className="w-32">
                                        ...
                                        <input
                                            ...
                                            placeholder="0"
                                            className={`w-full rounded-xl border px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all ${
